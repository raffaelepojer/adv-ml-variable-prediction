...
class CTVariablePredictionOnlyASTDataset(CTVariablePredictionDataset):
    """
    ...
    def __init__(self, data_manager: CTPreprocessedDataManager, token_distances=None, max_distance_mask=None,
        ...
        super(CTVariablePredictionOnlyASTDataset, self).__init__(data_manager, token_distances, max_distance_mask,
    ...
    def _get_next_sample(self):
        sample = super(CTVariablePredictionOnlyASTDataset, self)._get_next_sample()
