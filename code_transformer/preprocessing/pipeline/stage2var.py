...
class CTStage2VarSample:
    def __init__(self, tokens: List[CTToken], graph_sample: dict, token_mapping: dict, stripped_code_snippet: str, 
        func_name: str, docstring: str, variable_name, encoded_func_name: List = None, encoded_variable_name: List = None):
        self.tokens = tokens
...
class CTStage2VarMultiLanguageSample(CTStage2VarSample):
    def __init__(self, tokens: List[CTToken], graph_sample: dict, token_mapping: dict, stripped_code_snippet: str, 
        func_name: str, docstring: str, variable_name, language: str, encoded_func_name: List = None, encoded_variable_name: List = None):
        super().__init__(tokens, graph_sample, token_mapping, stripped_code_snippet, func_name, docstring, variable_name, encoded_func_name, encoded_variable_name)
    ...
    def from_compressed(compressed_sample):
        ...
        return CTStage2VarMultiLanguageSample(compressed_sample.tokens, graph_sample, compressed_sample.token_mapping,
                                           compressed_sample.stripped_code_snippet, compressed_sample.func_name,
                                           compressed_sample.docstring, compressed_sample.variable_name, compressed_sample.language,
                                           compressed_sample.encoded_func_name if hasattr(compressed_sample,
                                                                                           'encoded_func_name') else None,
                                           compressed_sample.encoded_variable_name if hasattr(compressed_sample,
                                                                                           'encoded_variable_name') else None)
